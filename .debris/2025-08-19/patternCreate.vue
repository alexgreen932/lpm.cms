<template>
    <ul class="icon-list b-blue bg-blue-l5 tx-black fs-9 p-05 fd-c g-05">
        <li><i class="fa-solid fa-hammer"></i> {{$__('Create Pattern same as usual section setting atyle and adding elements')}}</li>
        <li><i class="fa-solid fa-floppy-disk"></i> {{$__('Save as Custom Pattern')}} </li>
        <li><i class="fa-solid fa-folder-tree"></i> {{$__('Re use it where you need')}} </li>
