...
export const fields_presets = {
    ...
    logo_text: { title: __('Text'), key: 'logo_text', type: 'input', showIf: { logo_type: ['text'] } },
    slogan: { title: __('Slogan'), key: 'slogan', type: 'input', showIf: { logo_type: ['text'] } },
    logo_icon: { title: __('Icon(optionally)'), key: 'logo_icon', type: 'picker', ops:'icons', showIf: { logo_type: ['text'] } },
    logo_type: { title: __('Type'), key: 'logo_type', type: 'select', ops: 'logo_type' },
    logo_img: { title: __('Image'), key: 'logo_img', type: 'media', showIf: { logo_type: ['img'] } },
