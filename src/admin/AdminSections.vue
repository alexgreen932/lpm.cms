<template>
  <div v-if="ops.current_menu !== 99" class="admin-sec">
    ...
    <!-- ---{{ops.theme}} -->
    <TransitionGroup name="slideL" mode="out-in">
      ...
      <section-settings v-if="ops.current_menu == 'setting'" />
      <add-new v-if="ops.current_menu == 'add'" />
    </TransitionGroup>
      <!-- refactored way -->
    <!-- <div class="side-sections">
      <Transition name="slideL" mode="out-in">
        <component :is="currentView" :key="ops.current_menu" />
      </Transition>
    </div> -->
...
export default {
  ...
  //       add: 'add-new'
  //     }
  //     return map[this.ops.current_menu] || 'section-pages'
  //   }
  // },
  methods: {
    currentData() {
